...
defined('BASEPATH') OR exit('No direct script access allowed');
	...
	class MDataUser extends CI_Model {
		...
		public function getDataByCRC32($codeCrc32){
			$this->db->where("crc32", $codeCrc32);
			return $this->db->get("user");
		}
		...
		public function getTransaksiByIdUser($id_user){
			return $this->db->query("SELECT b.jenis, t.waktu_transaksi, t.total_pembelian, sb.harga, t.total_pembayaran, s.nama, s.alamat, s.kota, s.provinsi, s.latitude, s.longitude, t.id_promo, t.id as id_transaksi, s.id as id_spbu from transaksi t, spbu_bbm sb, bbm b, spbu s where t.id_spbu_bbm=sb.id and sb.id_spbu=s.id and sb.id_bbm=b.id and t.id_user='$id_user'");
		}
